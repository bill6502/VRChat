...
public class Drop_Reset_20231129 : UdonSharpBehaviour
{
    [Tooltip("[0,infinity]"), Min(0f)]
    public float randomForce = 0f;

    public PartPickup_20231129[] Objects;
    ...
    {
        //checking
        if (Objects.Length == 0 || Positions.Length == 0 || Objects.Length != Positions.Length)
            return;
